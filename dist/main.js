...
var _App = __webpack_require__(/*! ./scenes/App */ "./scenes/App/index.js");
...
exports.App = exports.AppConsumer = undefined;

var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

__webpack_require__(/*! ./styles.css */ "./scenes/App/styles.css");

var _react = __webpack_require__(/*! react */ "../node_modules/react/index.js");

var React = _interopRequireWildcard(_react);

var _ErrorBoundary = __webpack_require__(/*! ../../components/ErrorBoundary */ "./components/ErrorBoundary/index.jsx");

var _services = __webpack_require__(/*! ../../services */ "./services/index.js");

var _Search = __webpack_require__(/*! ../Search */ "./scenes/Search/index.jsx");

var _Status = __webpack_require__(/*! ../Status */ "./scenes/Status/index.jsx");

var _Result = __webpack_require__(/*! ../Result */ "./scenes/Result/index.jsx");
...
var App = exports.App = function (_React$Component) {
	...
	function App() {
		...
		_this.updateSearchExpression = _this.updateSearchExpression.bind(_this);
		_this.updateSearchBy = _this.updateSearchBy.bind(_this);
		return _this;
	}

	_createClass(App, [{
		key: 'updateSearchExpression',
		value: function updateSearchExpression(searchExpression) {
			this.setState({
				searchExpression: searchExpression
			});
			if (searchExpression) {
				var fetchData = new _services.FetchData();
				var result = void 0;
		...
		key: 'updateSearchBy',
		value: function updateSearchBy(searchBy) {
			this.setState({
				searchBy: searchBy
			});
		}
...
__webpack_require__(/*! ./styles.css */ "./scenes/Result/styles.css");
...
var _List = __webpack_require__(/*! ./scenes/List */ "./scenes/Result/scenes/List/index.jsx");
		...
		value: function render() {
			...
			if (this.props.data) {
				if (this.props.data.length) {
					result = React.createElement(_List.List, { data: this.props.data });
				} else {
					result = React.createElement(
						'div',
						{ className: 'result__not-found' },
						'No films found'
					);
				}
			}
...
/***/ "./scenes/Result/scenes/List/index.jsx":
/*!*********************************************!*\
  !*** ./scenes/Result/scenes/List/index.jsx ***!
  \*********************************************/
/*! no static exports found */
...
__webpack_require__(/*! ./styles.css */ "./scenes/Result/scenes/List/styles.css");
...
/***/ "./scenes/Result/scenes/List/styles.css":
/*!**********************************************!*\
  !*** ./scenes/Result/scenes/List/styles.css ***!
  \**********************************************/
/*! no static exports found */
...
__webpack_require__(/*! ./styles.css */ "./scenes/Search/styles.css");

var _react = __webpack_require__(/*! react */ "../node_modules/react/index.js");

var React = _interopRequireWildcard(_react);

var _SearchBy = __webpack_require__(/*! ./scenes/SearchBy */ "./scenes/Search/scenes/SearchBy/index.jsx");

var _SearchButton = __webpack_require__(/*! ./scenes/SearchButton */ "./scenes/Search/scenes/SearchButton/index.jsx");
	...
	_createClass(Search, [{
		...
		value: function render() {
			return React.createElement(
				...
				React.createElement('input', { ref: this.input, type: 'text', placeholder: 'Search expression' }),
				React.createElement(_SearchBy.SearchBy, null),
				React.createElement(_SearchButton.SearchButton, { input: this.input })
			);
		}
	}]);
...
/***/ "./scenes/Search/scenes/SearchButton/index.jsx":
/*!*****************************************************!*\
  !*** ./scenes/Search/scenes/SearchButton/index.jsx ***!
  \*****************************************************/
/*! no static exports found */
...
__webpack_require__(/*! ./styles.css */ "./scenes/Search/scenes/SearchButton/styles.css");

var _react = __webpack_require__(/*! react */ "../node_modules/react/index.js");

var React = _interopRequireWildcard(_react);

var _App = __webpack_require__(/*! ../../../App */ "./scenes/App/index.js");
...
var SearchButton = exports.SearchButton = function (_React$Component) {
	...
	_createClass(SearchButton, [{
		key: 'handleClick',
		value: function handleClick(updateSearchExpression) {
		...
		value: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					...
					null,
					function (_ref) {
						var updateSearchExpression = _ref.updateSearchExpression;
						return React.createElement(
							'button',
							{ onClick: function onClick() {
									_this2.handleClick(updateSearchExpression);
								} },
							'Search'
						);
					}
...
/***/ "./scenes/Search/scenes/SearchButton/styles.css":
/*!******************************************************!*\
  !*** ./scenes/Search/scenes/SearchButton/styles.css ***!
  \******************************************************/
/*! no static exports found */
...
/***/ "./scenes/Search/scenes/SearchBy/index.jsx":
/*!*************************************************!*\
  !*** ./scenes/Search/scenes/SearchBy/index.jsx ***!
  \*************************************************/
/*! no static exports found */
...
exports.SearchBy = undefined;

var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

__webpack_require__(/*! ./styles.css */ "./scenes/Search/scenes/SearchBy/styles.css");
...
var SearchBy = exports.SearchBy = function (_React$Component) {
	_inherits(SearchBy, _React$Component);

	function SearchBy() {
		_classCallCheck(this, SearchBy);

		return _possibleConstructorReturn(this, (SearchBy.__proto__ || Object.getPrototypeOf(SearchBy)).apply(this, arguments));
	}

	_createClass(SearchBy, [{
		key: 'handleButtonClick',
		value: function handleButtonClick(updateSearchBy, searchBy) {
		...
		value: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					...
					null,
					function (_ref) {
						var updateSearchBy = _ref.updateSearchBy,
						    searchBy = _ref.searchBy,
						    SEARCH_BY = _ref.SEARCH_BY;
						return React.createElement(
							'main',
							null,
							React.createElement(
								'button',
								{ className: searchBy === SEARCH_BY.TITLE ? 'selected' : '', onClick: function onClick() {
										return _this2.handleButtonClick(updateSearchBy, SEARCH_BY.TITLE);
									} },
								'Title'
							),
							React.createElement(
								'button',
								{ className: searchBy === SEARCH_BY.GENRE ? 'selected' : '', onClick: function onClick() {
										return _this2.handleButtonClick(updateSearchBy, SEARCH_BY.GENRE);
									} },
								'Genre'
							)
						);
...
/***/ "./scenes/Search/scenes/SearchBy/styles.css":
/*!**************************************************!*\
  !*** ./scenes/Search/scenes/SearchBy/styles.css ***!
  \**************************************************/
/*! no static exports found */
...
__webpack_require__(/*! ./styles.css */ "./scenes/Status/styles.css");
	...
	_createClass(Status, [{
		...
		value: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					'span',
					{ className: 'status__sort-by' },
					React.createElement(
						'span',
						{ className: 'status__sort-by-caption' },
						'Sort by'
					),
					React.createElement(
						'span',
						{ className: 'status__sort-by-value' },
						'release date'
					)
				),
				React.createElement(
					'span',
					{ className: 'status__rating' },
					'rating'
				)
			);
		}
...
var FetchData = exports.FetchData = function () {
	...
	_createClass(FetchData, [{
		...
		key: 'searchByGenre',
		value: function searchByGenre(searchExpression) {
			// eslint-disable-line no-unused-vars
			return [];
		}
	}]);
